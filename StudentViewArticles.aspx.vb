...
Partial Public Class StudentViewArticles
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim dsa As New SqlDataAdapter((("Select Title, Uploader, FileName from Files where (Title like '%" + TextBox1.Text & "%' or Tags like '%") + TextBox1.Text & "%' or Description like '%") + TextBox1.Text & "%')", con)
