...
Partial Public Class StaffLogin
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        con.Open()
        Dim cmd As New SqlCommand(((((((((("insert into StaffReg values ('" + TextBox3.Text & "','") + TextBox4.Text & "','") + TextBox5.Text & "','") + TextBox6.Text & "','") + DropDownList1.Text & "','") + DropDownList5.Text & "','") + TextBox7.Text & "','") + DropDownList2.Text & "-") + DropDownList3.Text & "-") + DropDownList4.Text & "')", con)
        cmd.ExecuteNonQuery()
        con.Close()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim dsa As New SqlDataAdapter("select FName, Mail, Password from StaffReg", con)
