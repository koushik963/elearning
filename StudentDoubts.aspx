<%@ Page Title="" Language="VB" MasterPageFile="~/Admin.master" AutoEventWireup="false" CodeFile="StudentDoubts.aspx.vb" Inherits="StudentDoubts" %>
...
<asp:Table ID="Table1" runat="server" BorderStyle="Double" BorderWidth="5px" 
    ...
    <td align=center bgcolor="#6600ff">
        <b><asp:Label ID="Label5" runat="server" Text="Replied By" style="font-size: x-large; color: #9999ff;"></asp:Label></b></td>
    ...
    <td align=left>
        <b><asp:Label ID="Label6" runat="server" Text="" style="font-size: x-large;"></asp:Label></b></td>
