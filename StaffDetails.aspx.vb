...
Partial Public Class StaffDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Dim dsa As New SqlDataAdapter("Select FName, Mail from StaffReg", con)
        ...
        For i = 0 To ds.Tables(0).Rows.Count - 1
            ...
            hy.NavigateUrl = "StaffDetails.aspx?mail=" & ds.Tables(0).Rows(i)(1).ToString()
        ...
        If Request.Params("mail") IsNot Nothing Then
            dsa = New SqlDataAdapter("select FName, LName, Mail, Password, Gender, Qualification, Specialization, DOB from StaffReg where Mail='" & Request.Params("mail").ToString() & "'", con)
            ds = New DataSet()
            dsa.Fill(ds)
